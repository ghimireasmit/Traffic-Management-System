...
class CustomerForm(forms.ModelForm):
    class Meta:
        ...
        fields=['address','mobile','profile_pic','bluebook_pic','license_pic']
...
class AdminRequestForm(forms.Form):
    ...
    customer=forms.ModelChoiceField(queryset=models.Customer.objects.all(),empty_label="User Name",to_field_name='id')
    mechanic=forms.ModelChoiceField(queryset=models.Mechanic.objects.all(),empty_label="Traffic Name",to_field_name='id')
...
class MechanicUpdateStatusForm(forms.Form):
    stat=(('Approved','Approved'),('Pending','Pending'),('Successful','Successful'))
    status=forms.ChoiceField( choices=stat)
